...
Usage:
  ...
  postplus research collect --run-handle <handle> [--wait-seconds <n>] [--poll-interval-seconds <n>] [--json] [--output <result.json>]
  postplus research scrape <source-key> --request <input-array.json> [--skill <skill-id>] [--output <result.json>]
  postplus research scrape --run-handle <handle> [--wait-seconds <n>] [--poll-interval-seconds <n>] [--json] [--output <result.json>]
